...
<body>
    <div>
                    ...
                    <div class="fila1">
                        <div class="column">
                            <div class="fila_servicios">
                                ...
                                <h3 class="subh3">¿Quiénes Somos?</h3>
                                <p>En nuestro centro ofrecemos una atención personalizada a cada alumno/a. Para nosotros lo más importante eres tú.</p>
                                <a class="boton_servicios">DETALLES</a>
                            </div>
                        </div>
                        <div class="column">
                            <div class="fila_servicios">
                                ...
                                <h3 class="subh3">Nuestros Precios</h3>
                                <p>Pincha aquí para conocer los precios de los Ciclos Formativos de Grado Superior y Grado Medio</p>
                                <a class="boton_servicios">DETALLES</a>
                            </div>
                        </div>
                        <div class="column">
                            <div class="fila_servicios">
                                ...
                                <h3 class="subh3">Seminarios</h3>
                                <p>Para completar tu formación contamos con seminarios formativos que se imparten en todos los cursos</p>
                                <a class="boton_servicios">DETALLES</a>
                            </div>
                        </div>
                        <div></div>
        ...
        <!--Falta hacer las media query para este bloque de instalaciones pero con las imagenes introducidas-->
        <div class="instalaciones">
            ...
            <div class="contenedor_bloques">
                <div class="columna1">
                    <div class="instalaciones_bloque1">
                        <h4>Centro</h4>
                        <p>El centro cuenta con todas las instalaciones necesarias para que podáis trabajar en las mejores condiciones.
                        </p>
                    </div>
                    <div class="instalaciones_bloque2">
                        <h4>Aulas</h4>
                        <p>Hemos diseñado las aulas en función de la necesidad de los alumnos/as y de las materias de las diferentes titulaciones.</p>
                    </div>
                </div>
                <div class="columna2">
                    <div class="instalaciones_bloque3">
                        <h4>Materiales</h4>
                        <p>Contamos con aulas-taller con todo el material necesario para las tareas teórico-prácticas y aulas polivalentes (informáticas, audiovisuales, etc.).</p>
                    </div>
                    <div class="instalaciones_bloque4">
                        <h4>Acceso WIFI</h4>
                        <p>Existe acceso a internet en todo el centro, tanto para los ordenadores instalados, como para vuestros propios dispositivos.</p>
                    </div>
                </div>
            </div>
        </div>
